...
public class Timer {
    ...
    private static int neededTime = 0;
    ...
    public static void stop() {
        SettingsModes.settings.put(ItemType.TIMER, ItemState.DISABLED);
        SettingsModes.timer.put(ItemType.RESUME, ItemState.DISABLED);
        state = TimerState.STOPPED;
        Bukkit.getScheduler().cancelTask(timerSchedular);
        Bukkit.broadcastMessage("§8[§6Timer§8] §cGestoppt");
    }
